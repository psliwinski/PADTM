...
public class Config extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase database) {
        String DATABASE_CREATE = "create table config " + "(_id integer primary key autoincrement," +
    ...
    public String getPublic() {
        try {
            ...
            Cursor cursor = db.query("config", new String[]{"pubKey",}, null, null, null,
                    null, null, null);
            if (cursor != null)
                cursor.moveToFirst();
            db.close();
    ...
    private PrivateKey getPrivate() {
        SQLiteDatabase db = this.getReadableDatabase();
        Cursor cursor = db.query("config", new String[]{"privKey",}, null, null,
                null, null, null, null);
        if (cursor != null)
            cursor.moveToFirst();
